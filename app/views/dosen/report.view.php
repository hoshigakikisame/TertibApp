                        ...
                        <div class="col-auto rounded-5 my-4 mx-2">
                            <form action="<?= $addNewReportEndpoint ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <datalist id="code_of_conducts">
                                                ...
                                                ?>
                                                <option value="<?= $codeOfConduct->getIdCodeOfConduct() ?>" label="<?= $codeOfConduct->getName() ?> - <?= $violationLevel->getName() ?> - <?= GenericUtil::intToRoman($violationLevel->getLevel()) ?>">
                                                </option>
                                                <?php endforeach; ?>
                                            </datalist>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Location"
                                                placeholder="Masukkan Lokasi Pelanggaran" name="location">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="deskripsi" rows="3"
                                                placeholder="Isi Deskripsi Pelanggaran" name="content"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row justify-content-end">
                                    <button class="btn btn-secondary col-4 text-white" type="submit"
                                        data-bs-toggle="modal" data-bs-target="#staticBackdrop">Send Report</button>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body text-center">
                                                <i class="bi bi-check-circle text-primary"
                                                    style="font-size:min(60vh,300px);"></i>
