                                    ...
                                    <div class="col">
                                        <div class="d-flex justify-content-left mb-2">
                                            ...
                                            <span class="badge text-bg-warning me-2">Level
                                                <?= $violation->getViolationLevelLevel() ?>
                                            </span>
                                            <span class="badge text-bg-danger me-2">+
                                                <?= $violation->getViolationLevelWeight() ?>
                                            </span>
                                        </div>
                                        <h6 class="mb-0">
                                            <span class="text-primary">#
                                                <?= $violation->getIdMahasiswaViolation() ?>
                                            </span>
                                            <span>
                                                <?= $violation->getFirstNameMahasiswa() . " " . $violation->getLastNameMahasiswa() ?>
                                            </span>
                                        </h6>
                                        <p>
                                            <?= $violation->getCodeOfConductName() ?>
                                        </p>
                                    </div>
