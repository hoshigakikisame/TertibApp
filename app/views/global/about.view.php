...
<main class="container">
	...
	<div class="row text-center gap-4 justify-content-center overflow-x-hidden">
		<h1>Tentang Kami</h1>
		<div class="col-lg-6 col justify-content-center slide-in-bottom">
		...
		<div class="row gy-3 justify-content-evenly flex-column flex-lg-row">
			...
			<div class="col-lg-4 col  text-start slide-in-right">
				...
				<ul class="list-group list-group-flush ">
					<li class="list-group-item d-flex gap-2 border-0 border py-0">
						...
						<p class="mb-1">Pelaporan Pelanggaran yang Mudah</p>
					</li>
					<li class="list-group-item d-flex gap-2 border-0 border py-0">
						<i class="bi bi-check2-all"></i>
						<p class="mb-1">Keamanan dan Transparansi</p>
					</li>
					<li class="list-group-item d-flex gap-2 py-0">
						<i class="bi bi-check2-all"></i>
						<p class="mb-1">Saluran Komunikasi yang Efektif</p>
					</li>
				</ul>
			</div>
		</div>
		<div class="col-lg-7 col  m-4 slide-in-bottom">Mari menjadi bagian dari upaya kolektif kami dalam menciptakan lingkungan belajar yang kondusif dan aman. Dengan mengikuti tata tertib kampus, Anda turut berkontribusi pada keberhasilan dan kesejahteraan bersama.</div>
		<div class="row justify-content-center mb-4 slide-in-bottom">
			<div class="col-auto">
