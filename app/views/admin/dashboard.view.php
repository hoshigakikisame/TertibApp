                            ...
                            <div class="col-11 border border-2 ms-4 px-4 py-3 rounded-3">
                                <div class="row flex-column">
                                    <div class="col">
                                        ...
                                        <h6 class="mb-0"><span class="text-primary">#<?= $report->getIdReport() ?></span> Dosen <?= $report->getUsernameDosen() ?> Reports Mahasiswa with Username <?= $report->getUsernameMahasiswa() ?> </h6>
