                        ...
                        <div class="col-11">
                            <div class="row flex-column">
                                <div class="col">
                                    ...
                                    <p>Melanggar tata tertib berupa tidak memakai pakaian berkerah disaat jam pelajaran dimulai</p>
                                </div>
                                <div class="col d-flex justify-content-end">
                                    <a class="btn btn-primary text-white justify-self-end" href="#" role="button">Report Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
